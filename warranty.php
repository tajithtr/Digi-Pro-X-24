...
<head>
    ...
    <title>Warranty Policy | DigiPro X24 - Sri Lanka</title>
    <meta name="description" content="DigiPro X24 Warranty Policy — Learn about our official product hardware warranties, claim procedures, and coverage terms in Sri Lanka.">
    <link rel="canonical" href="https://digiprox24.com/warranty.php">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://digiprox24.com/warranty.php">
    <meta property="og:title" content="Warranty Policy | DigiPro X24 - Sri Lanka">
    <meta property="og:description" content="DigiPro X24 Warranty Policy — Learn about our official product hardware warranties, claim procedures, and coverage terms in Sri Lanka.">
    <meta property="og:image" content="https://digiprox24.com/logo.png">
    <meta property="og:site_name" content="DigiPro X24">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://digiprox24.com/warranty.php">
    <meta property="twitter:title" content="Warranty Policy | DigiPro X24 - Sri Lanka">
    <meta property="twitter:description" content="DigiPro X24 Warranty Policy — Learn about our official product hardware warranties, claim procedures, and coverage terms in Sri Lanka.">
...
<body>
    ...
    <main class="policy-page">
        <section class="policy-hero">
            <div class="policy-badge">🛡️ Service Guarantee</div>
            <h1>Warranty <span>Policy</span></h1>
            <p>Our commitment to your product security. Read details of our warranty coverage on electrical and software parts.</p>
        </section>

        <div class="policy-body glass-panel" style="padding: 3rem; border-radius: 24px; line-height: 1.8;">
            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">🛡️ Warranty Period</h2>
            <p style="color: var(--text-muted);">
                We offer <strong>3-months, 6-months, 1-year, 2-years & 3-years</strong> warranty periods on all electrical items. If a customer experiences any issues with their products due to manufacturing faults within the warranty period, they may contact our customer service team for assistance.
            </p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">🤝 Customer Service Guarantee</h2>
            <p style="color: var(--text-muted);">
                We are dedicated to providing excellent customer service. Our team is available to assist customers with any inquiries, concerns, or issues related to their purchased items. Our standard service warranty and software warranty period ranges between <strong>3-months and 6-months</strong>.
            </p>

            <div style="margin-top: 3rem; border-top: 1px dashed rgba(255,94,0,0.2); padding-top: 1.5rem; text-align: center;">
                <blockquote style="font-size: 1.25rem; font-style: italic; color: var(--secondary-glow); font-weight: 700;">
