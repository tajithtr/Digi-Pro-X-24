...
<head>
    ...
    <title>About Us | Leading Computer & Tech Store in Sri Lanka - DigiPro X24</title>
    <meta name="description" content="Learn about DigiPro X24, Sri Lanka's trusted tech retailer for computers, laptops, accessories, repairs, and CCTV installation services.">
    <link rel="canonical" href="https://digiprox24.com/about.php">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://digiprox24.com/about.php">
    <meta property="og:title" content="About Us | Leading Computer & Tech Store in Sri Lanka - DigiPro X24">
    <meta property="og:description" content="Learn about DigiPro X24, Sri Lanka's trusted tech retailer for computers, laptops, accessories, repairs, and CCTV installation services.">
    <meta property="og:image" content="https://digiprox24.com/logo.png">
    <meta property="og:site_name" content="DigiPro X24">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://digiprox24.com/about.php">
    <meta property="twitter:title" content="About Us | Leading Computer & Tech Store in Sri Lanka - DigiPro X24">
    <meta property="twitter:description" content="Learn about DigiPro X24, Sri Lanka's trusted tech retailer for computers, laptops, accessories, repairs, and CCTV installation services.">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "AboutPage",
      "name": "About DigiPro X24",
      "url": "https://digiprox24.com/about.php",
      "description": "Information about DigiPro X24, premier computer shop and tech service provider in Sri Lanka."
    }
    </script>
    <script type="application/ld+json">
    {
...
<body>
    ...
    <main class="about-page">
        <section class="about-hero">
            ...
            <p>Welcome to <strong>Digi Pro X 24</strong>, your premier online destination for high-performance tech products and expert technical services in Sri Lanka.</p>
        </section>

        <section class="story-section" style="grid-template-columns: 1fr; gap: 2.5rem;">
            <!-- Story card -->
            <div class="story-text glass-panel" style="padding: 3rem; border-radius: 24px;">
                <h2 style="color: var(--primary-glow); font-size: 2rem; margin-bottom: 1.5rem; font-weight: 800;">Our Story & Purpose</h2>
                <p>Founded with a vision to empower individuals and businesses, <strong>Digi Pro X 24</strong> provides a seamless experience for purchasing cutting-edge consumer electronics, PC hardware, and professional tech services. We recognize that in today's digital age, you need a reliable partner that delivers top-tier hardware alongside expert technical support.</p>
                <p>We pride ourselves on offering strict quality control, verified authenticity, and reliable, on-time shipping across Sri Lanka. Our services are continually evolving to bring the latest innovations directly to your doorstep while maintaining absolute transparency and customer security.</p>
            </div>

            <!-- Pillars layout -->
            <div class="about-pillars-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; position: relative; z-index: 1;">
                <!-- Tech pillar -->
                <div class="glass-panel about-pillar-card" style="padding: 2rem; border-radius: 20px; text-align: left; border-left: 4px solid var(--primary-glow);">
                    <div style="font-size: 2.5rem; margin-bottom: 1rem;">💻</div>
                    <h3 style="color: #ffffff; font-size: 1.3rem; margin-bottom: 0.8rem; font-weight: 700;">Premium Tech Gear</h3>
                    <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.6;">From custom-built gaming PCs and surveillance systems to POS setups and everyday electronics, we supply premium gear designed for high performance.</p>
                </div>
                
                <!-- Services pillar -->
                <div class="glass-panel about-pillar-card" style="padding: 2rem; border-radius: 20px; text-align: left; border-left: 4px solid var(--secondary-glow);">
                    <div style="font-size: 2.5rem; margin-bottom: 1rem;">🛠️</div>
                    <h3 style="color: #ffffff; font-size: 1.3rem; margin-bottom: 0.8rem; font-weight: 700;">Expert Tech Services</h3>
                    <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.6;">Beyond hardware, we offer professional CCTV installations, POS software activations, OS setups, and dedicated technical support to keep your systems flawless.</p>
                </div>

                <!-- Reliability pillar -->
                <div class="glass-panel about-pillar-card" style="padding: 2rem; border-radius: 20px; text-align: left; border-left: 4px solid #10b981;">
                    <div style="font-size: 2.5rem; margin-bottom: 1rem;">🛡️</div>
                    <h3 style="color: #ffffff; font-size: 1.3rem; margin-bottom: 0.8rem; font-weight: 700;">Quality & Reliability</h3>
                    <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.6;">We pride ourselves on offering strict quality control, verified authentic products, warranty protection, and reliable, on-time delivery across Sri Lanka.</p>
                </div>
            </div>

            <!-- Quote block -->
            <div class="glass-panel about-quote-block" style="padding: 2.5rem 3rem; border-radius: 24px; text-align: center;">
                <blockquote style="font-size: 1.4rem; font-style: italic; color: var(--secondary-glow); font-weight: 800; margin: 0 auto; max-width: 600px;">
                    "Rich price will make a rich life"
                </blockquote>
                <p style="margin-top: 0.8rem; font-size: 0.95rem; color: var(--text-muted);">&mdash; Thank you for choosing Digi Pro X 24</p>
            </div>
        </section>

        <section class="location-panel glass-panel" style="border-radius:24px; padding:3rem; text-align:center;">
            <h2 style="color:#ffffff; font-size: 1.8rem; margin-bottom:1rem;">Our Main Hub</h2>
            <div class="location-details" style="color: var(--text-muted); line-height: 1.8;">
                <p style="font-weight: 700; color: #ffffff; font-size:1.15rem;">Digi Pro X 24 (Pvt) Ltd</p>
                <p>No.161, Wackwella Rd, Galle, Sri Lanka</p>
                <p style="margin-top:0.5rem;">📞 Phone: 070 6756006 | ✉️ Email: digipro24@gmail.com</p>
            </div>
        </section>
    </main>
