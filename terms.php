...
<head>
    ...
    <title>Terms &amp; Conditions | DigiPro X24 - Sri Lanka</title>
    <meta name="description" content="DigiPro X24 Terms and Conditions — Please read our terms of use, purchase policies, and platform rules before using our website.">
    <link rel="canonical" href="https://digiprox24.com/terms.php">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://digiprox24.com/terms.php">
    <meta property="og:title" content="Terms &amp; Conditions | DigiPro X24 - Sri Lanka">
    <meta property="og:description" content="DigiPro X24 Terms and Conditions — Please read our terms of use, purchase policies, and platform rules before using our website.">
    <meta property="og:image" content="https://digiprox24.com/logo.png">
    <meta property="og:site_name" content="DigiPro X24">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://digiprox24.com/terms.php">
    <meta property="twitter:title" content="Terms &amp; Conditions | DigiPro X24 - Sri Lanka">
    <meta property="twitter:description" content="DigiPro X24 Terms and Conditions — Please read our terms of use, purchase policies, and platform rules before using our website.">
...
<body>
    ...
    <main class="policy-page">
        <section class="policy-hero">
            <div class="policy-badge">📝 Terms of Use</div>
            <h1>Terms & <span>Conditions</span></h1>
            <p>Welcome to digiprox24.com. By accessing our website and making a purchase, you agree to comply with the following terms.</p>
        </section>

        <div class="policy-body glass-panel" style="padding: 3rem; border-radius: 24px; line-height: 1.8;">
            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">ℹ️ Product Information</h2>
            <p style="color: var(--text-muted);">We strive to provide accurate product descriptions, images, and pricing on our website. However, we cannot guarantee that all information is error-free. We reserve the right to correct any errors or inaccuracies and to update product information as needed.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">💳 Ordering and Payment</h2>
            <p style="color: var(--text-muted);">When you place an order on our website, you agree to pay the full amount for the products selected, including any applicable taxes and shipping fees. Payment can be made using the provided payment methods, and the transaction will be processed securely.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">🚚 Shipping and Delivery</h2>
            <p style="color: var(--text-muted);">We aim to process and ship orders in a timely manner. However, shipping times may vary depending on your location. Once an order has been shipped, we are not responsible for any delays or issues caused by the shipping carrier.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">🔄 Returns and Exchanges</h2>
            <p style="color: var(--text-muted);">If you are dissatisfied with your purchase, you may be eligible for a return or exchange within 05 days of receiving the product. Returned items must be in original condition with all tags and packaging intact. Please refer to our Returns Policy for more information.</p>
            <p style="color: var(--text-muted); font-weight: 600; border-left: 3px solid var(--accent); padding-left: 1rem; margin-top: 1rem;">
                After the goods are sold, at the time of return of the goods, "No money refunds". But, in case of any other omission or mistake on our part, we are sensitive to money refund. Also, if we fail to provide you with a solution from the side of our company for warranty or return, we will be sensitive about giving full money.
            </p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">📞 Contact Support</h2>
            <p style="color: var(--text-muted);">
                By using our website and making a purchase, you agree to abide by these terms and conditions. If you have any questions or concerns, please contact us at <a href="mailto:digiprox24@gmail.com" style="color: var(--primary-glow); font-weight:600;">digiprox24@gmail.com</a>.
            </p>
