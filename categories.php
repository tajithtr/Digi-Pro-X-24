...
<head>
    ...
    <title>All Categories | Computer Hardware, Laptops & Accessories - DigiPro X24</title>
    <meta name="description" content="Explore all product categories at DigiPro X24 Sri Lanka. Laptops, desktop PCs, components, audio, networking, storage & tech gadgets.">
    <link rel="canonical" href="https://digiprox24.com/categories.php">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://digiprox24.com/categories.php">
    <meta property="og:title" content="All Categories | Computer Hardware & Tech Gadgets - DigiPro X24">
    <meta property="og:description" content="Browse tech categories at DigiPro X24 Sri Lanka. High quality computers, laptops, gaming gear & CCTV cameras.">
    <meta property="og:image" content="https://digiprox24.com/logo.png">
    <meta property="og:site_name" content="DigiPro X24">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://digiprox24.com/categories.php">
    <meta property="twitter:title" content="All Categories | Computer Hardware & Tech Gadgets - DigiPro X24">
    <meta property="twitter:description" content="Browse tech categories at DigiPro X24 Sri Lanka. High quality computers, laptops, gaming gear & CCTV cameras.">
    ...
    <script type="application/ld+json">
    {
      ...
      "url": "https://digiprox24.com/categories.php",
      "description": "Explore all computer hardware, laptop, and gadget categories on DigiPro X24 Sri Lanka."
    }
    </script>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Categories",
          "item": "https://digiprox24.com/categories.php"
        }
      ]
    }
    </script>
...
<body>
    ...
    <main class="categories-page">
        ...
        <?php if (empty($categories)): ?>
            <div class="glass-panel" style="text-align: center; padding: 4rem; border-radius: 20px;">
                <h2 style="color: var(--text-main); margin-bottom: 1rem;">No Categories Found</h2>
                <p style="color: var(--text-muted); margin-bottom: 2rem;">We are currently updating our categories.</p>
            </div>
        <?php else: ?>
            <div class="category-grid">
                ...
                ?>
                    <a href="products.php?category=<?php echo $category['id']; ?>" class="category-card-clean">
                        ...
                        <div class="category-card-info-wrap">
                            ...
                            <span class="category-card-link">
                                <?php echo $is_service_cat ? 'View Services' : 'Explore Collection'; ?> <span class="arrow">➔</span>
                            </span>
                        </div>
                    </a>
                <?php endforeach; ?>
