...
<head>
    ...
    <title>Privacy Policy | DigiPro X24 - Sri Lanka</title>
    <meta name="description" content="DigiPro X24 Privacy Policy — Learn how we collect, use, and safeguard your personal information when you shop with us.">
    <link rel="canonical" href="https://digiprox24.com/privacy.php">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://digiprox24.com/privacy.php">
    <meta property="og:title" content="Privacy Policy | DigiPro X24 - Sri Lanka">
    <meta property="og:description" content="DigiPro X24 Privacy Policy — Learn how we collect, use, and safeguard your personal information when you shop with us.">
    <meta property="og:image" content="https://digiprox24.com/logo.png">
    <meta property="og:site_name" content="DigiPro X24">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://digiprox24.com/privacy.php">
    <meta property="twitter:title" content="Privacy Policy | DigiPro X24 - Sri Lanka">
    <meta property="twitter:description" content="DigiPro X24 Privacy Policy — Learn how we collect, use, and safeguard your personal information when you shop with us.">
...
<body>
    ...
    <main class="policy-page">
        <section class="policy-hero">
            <div class="policy-badge">🔒 Secure Privacy Document</div>
            <h1>Privacy <span>Policy</span></h1>
            <p>At digiprox24.com, we are committed to protecting your privacy and ensuring the security of your personal information.</p>
        </section>

        <div class="policy-body glass-panel" style="padding: 3rem; border-radius: 24px; line-height: 1.8;">
            <p>This Privacy Policy outlines how we collect, use, and protect the data you provide to us while visiting our website.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">📂 Information Collection</h2>
            <p style="color: var(--text-muted);">When you visit our website, we may collect certain information such as your name, email address, shipping address, and payment details when you make a purchase. This information is necessary to process your orders and provide you with a seamless shopping experience.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">⚙️ Data Usage</h2>
            <p style="color: var(--text-muted);">We use the data you provide to fulfill your orders, communicate with you about your purchases, and improve our services. Your information is securely stored and will never be shared, rented, or sold to third parties without your consent.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">🛡️ Security Measures</h2>
            <p style="color: var(--text-muted);">We take the security of your personal information seriously and have implemented industry-standard measures to safeguard your data against unauthorized access, disclosure, alteration, or destruction.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">🍪 Cookies</h2>
            <p style="color: var(--text-muted);">We use cookies to enhance your browsing experience and improve our website's functionality. These cookies may collect information such as your IP address, browser type, and pages visited. You have the option to disable cookies in your browser settings if you prefer.</p>

            <h2 style="color: var(--primary-glow); font-size: 1.4rem; border-bottom: 1px solid rgba(255,94,0,0.15); padding-bottom: 0.5rem; margin-top:2rem;">🔄 Updates to Privacy Policy</h2>
            <p style="color: var(--text-muted);">We reserve the right to update our Privacy Policy as needed to reflect changes in our practices or to comply with legal requirements. Any updates will be posted on our website, and we encourage you to review this policy periodically.</p>
            
            <p style="color: var(--text-muted); margin-top: 1.5rem;">
                By visiting digiprox24.com, you agree to the terms outlined in this Privacy Policy. If you have any questions or concerns about how we handle your personal information, please contact us at <a href="mailto:digiprox24@gmail.com" style="color: var(--primary-glow); font-weight:600;">digiprox24@gmail.com</a>. Thank you for trusting us with your privacy and for choosing us for your goods & services needs.
            </p>
